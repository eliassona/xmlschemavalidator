...
(deftest test-enum-restriction
  (let [f (validation-fn-of "<restriction base=\"string\">
	  ...
	  (is (= [true "small"] (f "small" predef-types nil nil)))
	  (is (= [true "medium"] (f "medium" predef-types nil nil)))
	  (is (= [true "large"] (f "large" predef-types nil nil)))
	  (is (= [false "asdf"] (f "asdf" predef-types nil nil)))
  ))
...
(deftest test-range-restriction
  (let [f (validation-fn-of "<restriction base=\"integer\">
	  ...
	  (is (= [true 36] (f 36 predef-types nil nil)))
	  (is (= [true 42] (f 42 predef-types nil nil)))
	  (is (= [false 43] (f 43 predef-types nil nil)))
  ))
...
(deftest test-simple-type-def
  (let [e (validation-expr-of 
    ...
    (is (= :type (-> e meta :kind)))
    (is (= [false 0] ((eval (first (vals e))) 0 predef-types nil nil)))
    (is (= [true 36] ((eval (first (vals e))) 36 predef-types nil nil)))
    ))
...
(deftest test-simple-type-reffing-predef
  (let [e (validation-expr-of 
    ...
    (is (= :type (-> e meta :kind)))
    (is (= [true 0] ((eval (first (vals e))) 0 predef-types nil nil)))
    (is (= [true 127] ((eval (first (vals e))) 127 predef-types nil nil)))
    (is (= [false 128] ((eval (first (vals e))) 128 predef-types nil nil)))
...
(deftest test-element
  (let [text "<element name=\"abyte\" type=\"byte\"/>"
    ...
    (is (= [true 0 :abyte] ((f :abyte) 0 predef-types nil nil)))
    (is (= [true 127 :abyte] ((f :abyte) 127 predef-types nil nil)))
    (is (= [false 128 :abyte] ((f :abyte) 128 predef-types nil nil)))
  ))
...
(deftest test-schema-with-predefs
  (let [f (validation-fn-of 
    ...
    (is (= [true 0 :anint] (f (parse-str "<anint>0</anint>") predef-types nil nil)))
    (is (= [true 0 :abyte] (f (parse-str "<abyte>0</abyte>") predef-types nil nil)))
    (is (= [false 128 :abyte] (f (parse-str "<abyte>128</abyte>") predef-types nil nil)))
  ))
...
(deftest test-schema-with-simple-type
  (let [f (validation-fn-of 
    ...
    (is (= [true 0 :abyte] (f (parse-str "<abyte>0</abyte>") predef-types nil nil)))
    (is (= [false 128 :abyte] (f (parse-str "<abyte>128</abyte>") predef-types nil nil)))
    (is (= [true 36 :my] (f (parse-str "<my>36</my>") predef-types nil nil)))
    (is (= [false 35 :my] (f (parse-str "<my>35</my>") predef-types nil nil)))
  ))
...
(deftest test-union
  (let [f (validation-fn-of 
    ...
    (is (= [false 35 :theunion] (f (parse-str "<theunion>35</theunion>") predef-types nil nil)))
    (is (= [true 36 :theunion] (f (parse-str "<theunion>36</theunion>") predef-types nil nil)))
    (is (= [true "small" :theunion] (f (parse-str "<theunion>small</theunion>") predef-types nil nil)))
    ))
...
(deftest test-sequence 
  (let [f (validation-fn-of 
    ...
    (is (= [true [[true 1 :seq1] [true "adsf" :seq2]]] (f (:content (parse-str "<udr><seq1>1</seq1><seq2>adsf</seq2></udr>")) predef-types nil nil)))
    (is (= [false []] (f (:content (parse-str "<udr><seq2>2</seq2><seq1>asdf</seq1></udr>")) predef-types nil nil)))
    (is (= [false []] (f (:content (parse-str "<udr><seq1>1</seq1></udr>")) predef-types nil nil)))
    (is (= [false []] (f (:content (parse-str "<udr><seq1>1</seq1><seq2>2</seq2><seq3>2</seq3></udr>")) predef-types nil nil)))
    (is (= [false []] (f (:content (parse-str "<udr><seq1>1</seq1><seq3>1</seq3></udr>")) predef-types nil nil)))
    ))
(deftest test-all 
  (let [f (validation-fn-of 
          "<all>
    ...
    (is (= [true [[true 1 :seq1][true "asdf" :seq2]]] (f (:content (parse-str "<udr><seq1>1</seq1><seq2>asdf</seq2></udr>")) predef-types nil nil)))
    (is (= [true [[true "asdf" :seq2][true 10 :seq1]]] (f (:content (parse-str "<udr><seq2>asdf</seq2><seq1>10</seq1></udr>")) predef-types nil nil)))
    (is (= [false []] (f (:content (parse-str "<udr><seq1>1</seq1></udr>")) predef-types nil nil)))
    (is (= [false []] (f (:content (parse-str "<udr><seq1>1</seq1><seq2>2</seq2><seq3>2</seq3></udr>")) predef-types nil nil)))
    (is (= [false []] (f (:content (parse-str "<udr><seq1>1</seq1><seq3>1</seq3></udr>")) predef-types nil nil)))
    ))
(deftest test-choice 
  (let [f (validation-fn-of 
    ...
    (is (= [false []] (f (:content (parse-str "<udr><seq1>1</seq1><seq2>2</seq2></udr>")) predef-types nil nil)))
    (is (= [false []] (f (:content (parse-str "<udr><seq2>2</seq2><seq1>1</seq1></udr>")) predef-types nil nil)))
    (is (= [true [true 1 :seq1]] (f (:content (parse-str "<udr><seq1>1</seq1></udr>")) predef-types nil nil)))
    (is (= [true [true "asdf" :seq2]] (f (:content (parse-str "<udr><seq2>asdf</seq2></udr>")) predef-types nil nil)))
    (is (= [false []] (f (:content (parse-str "<udr><seq1>1</seq1><seq2>2</seq2><seq3>2</seq3></udr>")) predef-types nil nil)))
    (is (= [false []] (f (:content (parse-str "<udr><seq1>1</seq1><seq3>1</seq3></udr>")) predef-types nil nil)))
    ))
...
(deftest test-complex-type 
  (let [f (validation-fn-of 
    ...
    (is (= [true [[false 0 :uniontest]] :udr] (f (parse-str "<udr><uniontest>0</uniontest></udr>") predef-types nil nil)))
    (is (= [true [[true 36 :uniontest]] :udr] (f (parse-str "<udr><uniontest>36</uniontest></udr>") predef-types nil nil)))
    (is (= [true [[true "small" :uniontest]] :udr] (f (parse-str "<udr><uniontest>small</uniontest></udr>") predef-types nil nil)))
    (is (= [true [[false "randomstring" :uniontest]] :udr] (f (parse-str "<udr><uniontest>randomstring</uniontest></udr>") predef-types nil nil)))
...
(deftest test-complex-content
  (let [types (assoc predef-types "personinfo" (fn [value types attributes elements] (if value [true [[true "Donald" :firstname][true "Duck" :lastname]]] [:sequence [:firstname :lastname]])))
    ...
    (is (= [:sequence [:firstname :lastname :address :city :country :zip]] (schema nil types nil nil)))
